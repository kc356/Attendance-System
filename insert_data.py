...
# val = ("comp3278", "Intro to DB", "off-site", "17:00:00", "00:00:00", "Monday", "Ping Luo", "https://hku.zoom.us/j/97686555806?pwd=NWxSNVRKTlNDU0NjYTgremxaQ3pldz09", "EEE", "https://moodle.hku.hk/course/view.php?id=80047", "No class tomorrow")
# cursor.execute(sql, val)
#
#
# sql = "INSERT INTO course (courseID, course_title, lecture_room_address, start_time, end_time, weekday, teacher_name, link, department, LectureNotes, TeacherMessage) VALUES (%s, %s, %s,%s, %s, %s,%s, %s, %s, %s, %s)"
# val = ("elec3848", "IDP", "off-site", "21:00:00", "00:00:00", "Thursday", "Sam lee", "https://hku.zoom.us/j/97686555806?pwd=NWxSNVRKTlNDU0NjYTgremxaQ3pldz09", "EEE", "https://moodle.hku.hk/course/view.php?id=80047", "No class tomorrow")
# cursor.execute(sql, val)
#
# sql = "INSERT INTO takes (student_id, course_id) VALUES (%s, %s)"
# val = ("456", "elec3848")
...
# cursor.execute(sql, val)
#
# sql = "UPDATE student SET timetable = 'http://59.148.246.6:11180/Schedule.png' WHERE student_id = '456'"
# cursor.execute(sql)
#
# sql = "INSERT INTO course (courseID, course_title, lecture_room_address, start_time, end_time, weekday, teacher_name, link, department, LectureNotes, TeacherMessage) VALUES (%s, %s, %s,%s, %s, %s,%s, %s, %s, %s, %s)"
# val = ("comp2396", "Java", "off-site", "17:30:00", "00:00:00", "Friday", "Sam lee", "https://hku.zoom.us/j/97686555806?pwd=NWxSNVRKTlNDU0NjYTgremxaQ3pldz09", "CS", "https://moodle.hku.hk/course/view.php?id=80047", "No class tomorrow")
# cursor.execute(sql, val)
sql = "INSERT INTO takes (student_id, course_id) VALUES (%s, %s)"
val = ("456", "comp2396")
cursor.execute(sql, val)
